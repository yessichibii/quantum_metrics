...
from quantum_information.metrics.distances import distance, mba_distance, weight_params
...
def build_asociative_qnode(train, y_train, n_totales, qubits_qram, qubits_dato, device, codigo="gray", noise=0.0, result="probs"):
